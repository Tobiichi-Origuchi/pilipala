...
class _HeaderControlState extends State<HeaderControl> {
  ...
  void scheduleExit() async {
    const List<int> scheduleTimeChoices = [-1, 15, 30, 60];
    showModalBottomSheet(
      context: context,
      elevation: 0,
      backgroundColor: Colors.transparent,
                  ...
                  : SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          ...widget.videoDetailCtr!.subtitles.map(
                            (e) => RadioListTile(
                              value: e.id,
                              title: Text(e.title),
                              groupValue: tempThemeValue,
          ...
          if (isFullScreen.value) ...[
            SizedBox(
              ...
              child: TextButton(
                ...
                child: const Text('发弹幕', style: textStyle),
              ),
            ),
            SizedBox(
              width: 34,
              ...
              child: Obx(
                () => IconButton(
                  ...
                  onPressed: () {
                    ctrl.isOpenDanmu.value = !ctrl.isOpenDanmu.value;
                  },
                  icon: Icon(
                    ctrl.isOpenDanmu.value
          ...
          Obx(
            () => SizedBox(
              ...
              child: TextButton(
                ...
                child: Text('${ctrl.playbackSpeed}X', style: textStyle),
              ),
            ),
          ),
          SizedBox(width: buttonSpace),
